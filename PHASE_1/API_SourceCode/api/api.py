...
api.add_resource(Article, "/article/<string:start_date>/<string:end_date>","/article/<string:start_date>/<string:end_date>/location=<string:location>","/article/<string:start_date>/<string:end_date>/key_terms=<string:key_terms>","/article/<string:start_date>/<string:end_date>/key_terms=<string:key_terms>/location=<string:location>")
app.run(debug=True)
